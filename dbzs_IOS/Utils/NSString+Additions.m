...
{
    NSRange range = [str rangeOfString:rangeOfString options:NSRegularExpressionSearch];
    if (range.location != NSNotFound) {
        NSString *matchStr = [str substringWithRange:range];
        matchStr = [matchStr substringFromIndex:sub.length];
        return [matchStr stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    }
    return nil;
}
